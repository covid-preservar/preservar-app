  ...
  class VouchersController < Admin::ResourcefulController
    ...
    def index_columns
      [
        ...
        {attr: :value, label: 'Face Value', sort: :value, formatter: -> (view, voucher) { view.number_to_currency voucher.face_value, locale: :pt }},
        {attr: :value, label: 'Paid Value', sort: :value, formatter: -> (view, voucher) { view.number_to_currency voucher.value, locale: :pt }},
        {attr: :value, label: 'Used Value', sort: :value, formatter: -> (view, voucher) { view.number_to_currency voucher.used_value, locale: :pt }},
