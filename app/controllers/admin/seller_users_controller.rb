  ...
  class SellerUsersController < Admin::ResourcefulController
    ...
    def index_columns
      [
        ...
        { attr: :seller, label: 'Seller', sort: nil, formatter: ->(view, seller_user) { view.link_to("Seller: #{seller_user.seller}", [:admin, seller_user.seller]) if seller_user.seller.present? } },
