...
class PartnerLogoUploader < BaseUploader
  ...
  Attacher.validate do
    ...
    validate_mime_type_inclusion %w[image/svg+xml image/png], message: 'tem que ser formato SVG'
    validate_extension_inclusion %w[svg png], message: 'tem que ser formato SVG'
  end
end
